...
routeFilenames.push('shop/shopApi');
routeFilenames.push('item/itemApi');
routeFilenames.push('hero/heroApi');
routeFilenames.push('contract/contractApi');
routeFilenames.push('contractRun/contractRunApi');
routeFilenames.push('ingredient/ingredientApi');
routeFilenames.push('enchantment/enchantmentApi');
routeFilenames.push('craftingSession/craftingSessionApi');
routeFilenames.push('itemBreakdown/itemBreakdownApi');
routeFilenames.push('recipe/recipeApi');
routeFilenames.push('report/reportApi');
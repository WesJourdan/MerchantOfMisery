...
} from "./chunk-IPHDWHLU.js";
import {
  require_scheduler,
  require_tracing
} from "./chunk-W6KW6MJU.js";
import {
  require_react
} from "./chunk-BVBZI2TO.js";
import {
  require_object_assign
} from "./chunk-PUPJFG4Y.js";
import {
  __commonJS,
  __toESM
} from "./chunk-G3PMV62Z.js";

// web/node_modules/react-reconciler/cjs/react-reconciler.development.js
var require_react_reconciler_development = __commonJS({
  "web/node_modules/react-reconciler/cjs/react-reconciler.development.js"(exports, module) {
    "use strict";
    if (true) {
...
// web/node_modules/react-reconciler/index.js
var require_react_reconciler = __commonJS({
  "web/node_modules/react-reconciler/index.js"(exports, module) {
    "use strict";
    if (false) {
      module.exports = null;
    } else {
...
// web/node_modules/fast-deep-equal/index.js
var require_fast_deep_equal = __commonJS({
  "web/node_modules/fast-deep-equal/index.js"(exports, module) {
    "use strict";
...
// web/node_modules/@react-three/fiber/dist/react-three-fiber.esm.js
var React = __toESM(require_react());

// web/node_modules/zustand/esm/index.js
...
// web/node_modules/use-asset/dist/index.js
...
function handleAsset(fn, cache, args, lifespan = 0, preload = false) {
  for (const entry2 of cache) {
    if ((0, import_fast_deep_equal.default)(args, entry2.args)) {
      if (preload) return;
      if (entry2.error) throw entry2.error;
      if (entry2.response) return entry2.response;
...
function clear(cache, ...args) {
  if (args === void 0 || args.length === 0) cache.splice(0, cache.length);
  else {
...
// web/node_modules/react-merge-refs/dist/react-merge-refs.esm.js
...
// web/node_modules/react-use-measure/dist/index.js
...
var is = {
  ...
  equ(a, b) {
    ...
    for (i2 in b) if (a[i2] !== b[i2]) return false;
...
function createRenderer(roots2) {
  function diffProps(instance, {
    ...
    if (accumulative) {
      ...
      for (let i2 = 0; i2 < previousKeys.length; i2++) if (!props.hasOwnProperty(previousKeys[i2])) entries.unshift([previousKeys[i2], DEFAULT + "remove"]);
    }
  ...
  function applyProps2(instance, data) {
    ...
    changes.forEach(([key, value, isEvent, keys]) => {
      ...
      if (isEvent) {
        ...
        if (!isLinear && currentInstance[key] instanceof Texture) currentInstance[key].encoding = sRGBEncoding;
      }
  ...
  const reconciler2 = (0, import_react_reconciler.default)({
    ...
    commitUpdate(instance, [reconstruct, diff], type, oldProps, newProps, fiber) {
      ...
      else applyProps2(instance, diff);
    },
    hideInstance(instance) {
...
var createStore2 = (applyProps2, invalidate2, advance2, props) => {
  ...
  if (linear) gl.outputEncoding = LinearEncoding;
  if (flat) gl.toneMapping = NoToneMapping;
  if (frameloop === "never") {
    clock.stop();
    clock.elapsedTime = 0;
  }
  const rootState = create((set, get) => {
    ...
    if (!isCamera) {
      camera.position.z = 5;
      if (cameraOptions) applyProps2(camera, cameraOptions);
...
function createLoop(roots2) {
  ...
  function invalidate2(state) {
    if (!state) return roots2.forEach((root) => invalidate2(root.store.getState()));
  ...
  function advance2(timestamp, runGlobalEffects = true, state) {
    ...
    if (!state) roots2.forEach((root) => render$1(timestamp, root.store.getState()));
...
function render(element, canvas, {
  ...
  if (fiber && state) {
    if (props.dpr !== void 0 && !is.equ(state.viewport.dpr, calculateDpr(props.dpr))) state.setDpr(props.dpr);
...
react-reconciler/cjs/react-reconciler.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MG5PJAZA.js.map

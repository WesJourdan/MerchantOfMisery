/**
 * Wraps all Hero views in a wrapping container. If you want to give all
 * Hero views a sidebar for example, you would set that here.
 * 
...
const HeroLayout = ({ children, className, title }) => {
  return (
...
HeroLayout.Skeleton = DefaultLayout.Skeleton;

/**
 * Wraps all Ingredient views in a wrapping container. If you want to give all
 * Ingredient views a sidebar for example, you would set that here.
 * 
...
const IngredientLayout = ({ children, className, title }) => {
  return (
...
IngredientLayout.Skeleton = DefaultLayout.Skeleton;

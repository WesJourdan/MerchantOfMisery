...
// import services
import { useRecipeFromMap } from '../recipeService';

const RecipeListItem = ({ id }) => {
  const recipe = useRecipeFromMap(id);
...
const Skeleton = () => {
  return (
    <li className="animate-pulse list-none p-2 block cursor-default select-none">
      <p className='bg-gray-600 text-gray-600 w-fit' href="#"> Recipe Name</p>
    </li>
  )
}
// add the skeleton to the component so we can access it in other components (RecipeList in this case)
RecipeListItem.Skeleton = Skeleton;

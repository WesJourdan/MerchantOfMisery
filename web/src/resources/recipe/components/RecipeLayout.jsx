/**
 * Wraps all Recipe views in a wrapping container. If you want to give all
 * Recipe views a sidebar for example, you would set that here.
 * 
...
const RecipeLayout = ({ children, className, title }) => {
  return (
...
RecipeLayout.Skeleton = DefaultLayout.Skeleton;

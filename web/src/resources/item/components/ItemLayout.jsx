/**
 * Wraps all Item views in a wrapping container. If you want to give all
 * Item views a sidebar for example, you would set that here.
 * 
...
const ItemLayout = ({ children, className, title }) => {
  return (
...
ItemLayout.Skeleton = DefaultLayout.Skeleton;

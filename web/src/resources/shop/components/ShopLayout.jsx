/**
 * Wraps all Shop views in a wrapping container. If you want to give all
 * Shop views a sidebar for example, you would set that here.
 * 
...
const ShopLayout = ({ children, className, title }) => {
  return (
...
ShopLayout.Skeleton = DefaultLayout.Skeleton;

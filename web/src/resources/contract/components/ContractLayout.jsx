/**
 * Wraps all Contract views in a wrapping container. If you want to give all
 * Contract views a sidebar for example, you would set that here.
 * 
...
const ContractLayout = ({ children, className, title }) => {
  return (
...
ContractLayout.Skeleton = DefaultLayout.Skeleton;

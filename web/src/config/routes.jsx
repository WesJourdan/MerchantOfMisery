...
import YTRoute from '../global/components/routing/YTRoute.jsx';
import ShopDashboard from '../resources/shop/views/ShopDashboard.jsx';
import ShopList from '../resources/shop/views/ShopList.jsx';
...
const routes =
  <Switch>
    <YTRoute exact login={true} path="/" component={ShopList} />
    <YTRoute exact login={true} path="/:shopId" component={ShopDashboard} />
